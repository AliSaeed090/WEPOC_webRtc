...
import IMCreateGroupComponent from '../../Core/chat/ui/IMCreateGroupComponent/IMCreateGroupComponent';
import { channelManager } from '../../Core/chat/firebase/index';
...
const FriendList = (props) => {
  ...
  useLayoutEffect(() => {
    props.navigation.setOptions({
      ...
      headerRight:
        (<TextButton style={{ marginHorizontal: 7 }} onPress={onADD}>
          {IMLocalized('ADD')}
        </TextButton>),
      headerStyle: {
