...
const SmsAuthenticationScreen = (props) => {
  ...
  const signInWithPhoneNumber = (userValidPhoneNumber) => {
    console.log("signInWithPhoneNumber: "+userValidPhoneNumber);
    setLoading(true);
  ...
  return (
    <View style={styles.container}>
      <ImageBackground
          source={
            require('../../../../assets/wepoc/back1.jpg')
          }
      ...
      <KeyboardAwareScrollView
        ...
        {isSigningUp && (
          <TermsOfUseView 
            ...
            tosLink={appConfig.tosLink}  privacyPolicyLink={appConfig.privacyPolicyLink}  style={styles.tos} />
        )}
