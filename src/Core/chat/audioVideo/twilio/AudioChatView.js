...
const AudioChatView = (props) => {
  ...
  const [backgroundBlurImage] = useState(
    audioVideoChatReceivers.length > 0 ? audioVideoChatReceivers[0]?.profilePictureURL : "https://www.iosapptemplates.com/wp-content/uploads/2019/06/empty-avatar.jpg"
  );
